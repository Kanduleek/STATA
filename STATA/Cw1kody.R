...
# Wektory ----------------------------------------
# Umieszczamy w nich obserwowane wartoœci danej zmiennej.
...
#funkcja c - combine = przyjmujê listê argumentów
...
# Ramki danych ----------------------------------------
# S¹ to odpowiedniki arkuszy danych.
...
# Uwaga: Wiêkszoœæ danych w R przechowywana jest w postaci ramek danych.

# Listy ----------------------------------------
# Wiêkszoœæ funkcji zwraca wynik w postaci listy.
...
head(Demografia, 5)
##                Gêstoœæ Przyrost Praca Bezrobocie Bud¿et Trasy Telefon
## Warszawa          3322     -4.0   331        3.2   3166   752     271
## Bia³ystok         3046      3.8   304        9.3   1159   107     204
## Bydgoszcz         2192      0.9   307        9.9   1350   166     231
## Czêstochowa       1622     -0.3   302       13.0   1852   169     133
## Gdañsk            1762      0.7   305       10.9   2925   307     155
